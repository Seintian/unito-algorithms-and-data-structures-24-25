...
void hash_table_put(HashTable* table, void* key, void* value);         // Insert or update a key-value pair
...
void hash_table_map(const HashTable* table, void (*func)(void* key, void* value));       // Apply a function to each key-value pair
