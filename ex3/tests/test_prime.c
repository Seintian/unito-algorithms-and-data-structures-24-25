...
void test_is_prime(void) {
    ...
    TEST_ASSERT_EQUAL(0, is_prime(41));
}
...
void test_next_prime(void) {
    ...
    TEST_ASSERT_EQUAL(17, next_prime(17));
    TEST_ASSERT_EQUAL(17, next_prime(18));
    TEST_ASSERT_EQUAL(19, next_prime(19));
    TEST_ASSERT_EQUAL(19, next_prime(20));
    ...
    TEST_ASSERT_EQUAL(41, next_prime(31));
    TEST_ASSERT_EQUAL(41, next_prime(32));
    TEST_ASSERT_EQUAL(41, next_prime(33));
    TEST_ASSERT_EQUAL(41, next_prime(34));
    TEST_ASSERT_EQUAL(41, next_prime(35));
    TEST_ASSERT_EQUAL(41, next_prime(36));
    ...
    TEST_ASSERT_EQUAL(43, next_prime(41));
}